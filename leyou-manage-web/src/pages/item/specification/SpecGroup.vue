<template>
  <div>
      ...
      <template slot="items" slot-scope="props">
        <tr @click="selectGroup(props.item)">
          ...
          <td class="justify-center layout px-0">
            <v-btn @click.stop="editGroup(props.item)" icon>
              <i class="el-icon-edit"/>
            </v-btn>
            <v-btn @click.stop="deleteGroup(props.item.id)" icon>
    ...
    <v-btn @click="addGroup" color='primary'>新增分组</v-btn>
    <v-dialog height="200" v-model="show" width="300">
      <v-card>
        <v-card-text>
