<template>
  <v-app :dark="dark">
    ...
    >
      <v-toolbar class="transparent" flat>
        <v-list class="pa-0">
          <v-list-tile avatar>
            ...
            <v-list-tile-content>
              <v-list-tile-title>咸鱼至尊</v-list-tile-title>
            </v-list-tile-content>
          </v-list-tile>
        </v-list>
      </v-toolbar>
      ...
      <v-list class="pt-0" dense>
        ...
        >
          ...
          <!-- 二级菜单 -->
          <v-list-tile :key="subItem.title" :to="item.path + subItem.path" v-for="subItem in item.items">
            <v-list-tile-content>
    ...
    >
      ...
      <!-- 调色板 -->
      <v-btn @click.stop="dark = !dark" icon>
